...
-- Last modification date: 2026-03-09 21:38:06.213
...
CREATE TABLE Departamento (
    ...
    CONSTRAINT ak_nombre_depto UNIQUE (nombre_depto) NOT DEFERRABLE  INITIALLY IMMEDIATE,
    CONSTRAINT ak_jefe_depto UNIQUE (id_jefe) NOT DEFERRABLE  INITIALLY IMMEDIATE,
...
CREATE TABLE Empleado (
    ...
    direccion_puerta varchar(30)  NOT NULL,
